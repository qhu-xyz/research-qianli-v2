...
OUTPUT_DIR = "/opt/temp/qianli/miso/apr_v2"
AUCTION = "auc2604"
VERSION = "v2"
AUCTION_ROUND = 1
...
def print_summary(results):
    print(f"\n{'=' * 60}")
    print("SUMMARY - MISO Sell Apr 2026 V2 (auc2604)")
    print(f"{'=' * 60}")
