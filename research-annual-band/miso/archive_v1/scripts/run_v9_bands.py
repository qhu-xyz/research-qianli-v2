"""DEPRECATED — archived 2026-03-17. Uses old data sources (all_residuals_v2.parquet,
aq*_all_baselines.parquet). New work should use canonical get_trades_of_given_duration().
