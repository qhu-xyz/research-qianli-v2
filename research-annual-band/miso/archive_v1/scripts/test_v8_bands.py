...
"""Comprehensive tests for run_v8_bands.py.
...
Usage:
    ...
    python /home/xyz/workspace/research-qianli-v2/research-annual/scripts/test_v8_bands.py
"""
...
def test_pipeline_gate_structure():
    ...
    # Build metrics dict as run_round_v8 would
    metrics = {
        "coverage": {
...
def test_no_symmetric_parameter():
    """v8 removed symmetric parameter. Verify the function signature."""
...
# ─── Test 30: v8 constants ──────────────────────────────────────────────────

def test_v8_constants():
    """Verify v8-specific constant values."""
    print("\n[Test 30] v8 constants")
...
def main():
    print("=" * 70)
    print("  test_v8_bands.py — Comprehensive tests for v8 bands")
    print("=" * 70)
