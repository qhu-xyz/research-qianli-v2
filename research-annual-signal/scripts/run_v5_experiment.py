"""v5: Tiered labels + formula score (rank_ori) as 7th feature (Set AF).

Combines both improvements: tiered relevance labels (v3) and formula-as-feature (v4).
"""
...
run_comparison(
    batch_id="annual",
    iteration=5,
    output_path=str(Path(__file__).resolve().parent.parent / "reports" / "v5_comparison.md"),
)
