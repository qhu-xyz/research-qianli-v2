...
- **Current iteration**: 1 complete (FAILED), iter2 next
...
- No screening phase — direct to full 12-month benchmark
- Maximally simplified direction with explicit anti-premature-handoff instructions
